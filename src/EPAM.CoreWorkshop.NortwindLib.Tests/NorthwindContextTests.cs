using EPAM.CoreWorkshop.NortwindLib.Model;
...
namespace EPAM.CoreWorkshop.NorthwindLib.Tests
{
    ...
    public class NorthwindContextTests
    {
        ...
        public void GetDataFromSqlServer()
        {
            ...
            optionsBuilder.UseSqlServer("Server=172.27.121.196;Database=Northwind;user=sa;password=bY!SWlTB#hswZgp1z");
        ...
        {
            var optionsBuilder = new DbContextOptionsBuilder<NorthwindContext>();
            optionsBuilder.UseMySql("Server=epam-corewsvm17.northeurope.cloudapp.azure.com;Database=Northwind;User=user;Password=123;Compress=true",
                opt =>
                {
